...
public class GainSkillPoint extends PotionEffectWrapper {
    private final String defaultIcon;

    public GainSkillPoint(String effect, String defaultIcon) {
    ...
    public PotionEffectWrapper copy() {
        return new GainSkillPoint(getEffect(), defaultIcon).setCharges(charges);
    }
