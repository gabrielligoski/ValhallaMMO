...
public class PotionEffectRegistry {
    ...
    public static void registerEffects() {
        ...
        registerNewEffect(new GainSkillPoint("GAIN_SKILL_POINT", "\uEE8D").addModifier(Material.EXPERIENCE_BOTTLE, 0.05, 1));
        registerNewEffect(new RefundSkillPoint("REFUND_SKILL_POWER", "POWER","\uEE8D").addModifier(Material.EXPERIENCE_BOTTLE, 0.05, 1));
        registerNewEffect(new RefundSkillPoint("REFUND_SKILL_BUILDING", "BUILDING","\uEE8D").addModifier(Material.EXPERIENCE_BOTTLE, 0.05, 1));
        registerNewEffect(new RefundSkillPoint("REFUND_SKILL_ALCHEMY", "ALCHEMY","\uEE8D").addModifier(Material.EXPERIENCE_BOTTLE, 0.05, 1));
        registerNewEffect(new RefundSkillPoint("REFUND_SKILL_SMITHING", "SMITHING","\uEE8D").addModifier(Material.EXPERIENCE_BOTTLE, 0.05, 1));
        registerNewEffect(new RefundSkillPoint("REFUND_SKILL_ENCHANTING", "ENCHANTING","\uEE8D").addModifier(Material.EXPERIENCE_BOTTLE, 0.05, 1));
        registerNewEffect(new RefundSkillPoint("REFUND_SKILL_FARMING", "FARMING","\uEE8D").addModifier(Material.EXPERIENCE_BOTTLE, 0.05, 1));
        registerNewEffect(new RefundSkillPoint("REFUND_SKILL_MINING_DIGGING", "MINING_DIGGING","\uEE8D").addModifier(Material.EXPERIENCE_BOTTLE, 0.05, 1));
        registerNewEffect(new RefundSkillPoint("REFUND_SKILL_FISHING", "FISHING","\uEE8D").addModifier(Material.EXPERIENCE_BOTTLE, 0.05, 1));
        registerNewEffect(new RefundSkillPoint("REFUND_SKILL_WOODCUTTING", "WOODCUTTING","\uEE8D").addModifier(Material.EXPERIENCE_BOTTLE, 0.05, 1));
        registerNewEffect(new RefundSkillPoint("REFUND_SKILL_ARCHERY", "ARCHERY","\uEE8D").addModifier(Material.EXPERIENCE_BOTTLE, 0.05, 1));
        registerNewEffect(new RefundSkillPoint("REFUND_SKILL_LIGHT_ARMOR", "LIGHT_ARMOR","\uEE8D").addModifier(Material.EXPERIENCE_BOTTLE, 0.05, 1));
        registerNewEffect(new RefundSkillPoint("REFUND_SKILL_HEAVY_ARMOR", "HEAVY_ARMOR","\uEE8D").addModifier(Material.EXPERIENCE_BOTTLE, 0.05, 1));
        registerNewEffect(new RefundSkillPoint("REFUND_SKILL_LIGHT_WEAPONS", "LIGHT_WEAPONS","\uEE8D").addModifier(Material.EXPERIENCE_BOTTLE, 0.05, 1));
        registerNewEffect(new RefundSkillPoint("REFUND_SKILL_LIGHT_HEAVY_WEAPONS", "HEAVY_WEAPONS","\uEE8D").addModifier(Material.EXPERIENCE_BOTTLE, 0.05, 1));
