...
public class MiningStatSource implements AccumulativeStatSource {
    ...
    /**
     * Grants stats only if the player is directly looking at a block the MiningDiggingSkill can grant exp for
     */
    public MiningStatSource(String stat){
        ...
        if (numberType == null) {
            throw new IllegalArgumentException("MiningStatSource:" + MiningDiggingProfile.class.getSimpleName() + " with stat " + stat +
